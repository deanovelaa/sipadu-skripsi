                ...
                <div className="relative">
                  ...
                  {isStatusDropdownOpen && (
                    <div className="absolute right-0 mt-1 w-40 bg-white border border-gray-200 rounded-lg shadow-lg z-10">
                      {['Semua Status', 'Diajukan', 'Diterima', 'Revisi'].map((opt) => (
                        <button
                          key={opt}
                          type="button"
                          onClick={() => {
                      ...
                      <tr key={idx} className="border-b border-gray-100 hover:bg-gray-50 transition-colors" >
                        ...
                        <td className="py-4 px-6 text-right">
                          <div className="flex items-center gap-3 justify-start">
                            <button className="text-gray-400 hover:text-gray-600 transition-colors" onClick={() => navigate(`/pimpinan/pencatatan/pemantauan/detail/lahan`)}>
                              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" >
                                <path d="M3 8.3335C5 4.00016 11 4.00016 13 8.3335" stroke="#2563EB" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M7.99984 10.6667C7.26344 10.6667 6.6665 10.0697 6.6665 9.33333C6.6665 8.59693 7.26344 8 7.99984 8C8.73624 8 9.33317 8.59693 9.33317 9.33333C9.33317 10.0697 8.73624 10.6667 7.99984 10.6667Z" stroke="#2563EB" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                              </svg>
                            </button>
                            <button className="text-[#697077] hover:text-gray-600 transition-colors" onClick={() => navigate(`/pimpinan/pencatatan/pemantauan/detail/lahan`)}>
                              {/* <svg
                      ...
                      return (
                        <React.Fragment key={key}>
                          <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                            ...
                            <td className="py-4 px-6">
                              {renderStatus(overallStatus, selectedProduksiYear)}
                            </td>
                            <td className="py-4 px-6">
                              <span className="text-[14px] text-[#121619]">
                                {row.terakhirUpdate}
                            ...
                            <td className="py-4 px-6">
                              <div className="flex items-center justify-end gap-3">
                                <button className="text-[#2563EB] hover:text-[#1D4ED8] transition-colors" onClick={() => navigate(`/pimpinan/pencatatan/pemantauan/detail/panen`)}>
                                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M3 8.3335C5 4.00016 11 4.00016 13 8.3335" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                    <path d="M7.99984 10.6667C7.26344 10.6667 6.6665 10.0697 6.6665 9.33333C6.6665 8.59693 7.26344 8 7.99984 8C8.73624 8 9.33317 8.59693 9.33317 9.33333C9.33317 10.0697 8.73624 10.6667 7.99984 10.6667Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                  </svg>
