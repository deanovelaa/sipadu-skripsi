...
const TambahPenggunaPage = () => {
    ...
    const handleSimpan = () => {
        ...
        const nextId = existing.length ? Math.max(...existing.map((u) => u.id)) + 1 : 1;
        const newUser = {
            id: nextId,
    ...
    return (
        <div className="w-full min-h-screen bg-[#F8FAFC] pb-10">
            ...
            <div className="bg-[#F8FAFC] px-8 py-10">
                <h1 className="text-[#111827] text-[24px] font-semibold">Tambah Pengguna Baru</h1>
            </div>
            ...
            <div className="bg-white mx-8 border border-[#E2E8F0] rounded-[16px] overflow-hidden shadow-sm">
                <div className="p-10">
                    {/* Header Form */}
                    <div className="mb-8">
                        <h2 className="text-[#111827] text-[16px] font-semibold font-mona-sans">Isi Formulir Data Pengguna Baru</h2>
                        <p className="text-[#64748B] text-[14px] mt-1 font-mona-sans">
                            Pastikan data pengguna sesuai sebelum mengkonfirmasi pembuatan pengguna baru
                        </p>
                    </div>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className="w-full px-4 py-3 rounded-lg border border-[#E2E8F0] appearance-none focus:outline-none bg-white text-[14px] text-[#111827]"
                                >
                        ...
                        <div className="flex flex-col gap-2 md:col-span-2">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    onChange={(e) => setFormData((p) => ({ ...p, peran: e.target.value }))}
                                    className="w-full px-4 py-3 rounded-lg border border-[#E2E8F0] appearance-none focus:outline-none bg-white text-[14px] text-[#111827]"
                                >
                                    <option>Kecamatan Sumbersari</option>
                                    <option>Kecamatan Kencong</option>
                                    <option>Verifikator DTPHP</option>
                                    <option>Pimpinan DTPHP</option>
                                    <option>Operator DTPHP</option>
                                </select>
                                <div className="absolute inset-y-0 right-4 flex items-center pointer-events-none">
                                    <svg className="w-4 h-4 text-[#94A3B8]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7" />
                    ...
                    <div className="mt-10 flex justify-end gap-4">
                        <button
                            ...
                            className="px-10 py-2.5 border border-[#E2E8F0] text-[#111827] text-[14px] font-normal hover:bg-gray-50 transition-colors rounded-lg"
                        >
                            Batal
                        </button>
                        <button
                            ...
                            className="px-8 py-2.5 bg-[#16A34A] text-white text-[14px] font-normal hover:bg-[#15803D] transition-colors flex items-center gap-2 rounded-lg"
                        >
