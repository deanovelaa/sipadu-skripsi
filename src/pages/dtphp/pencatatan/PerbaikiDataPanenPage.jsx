...
const PerbaikiDataPanenPage = () => {
    ...
    const [_sConfirmUploadOpen, setIsConfirmUploadOpen] = useState(false);
    ...
    const filteredRows = rows
        ...
        .map((row) => {
            ...
            const children = row.children.filter((child) => allowed.includes(child.komoditi));
...
export default PerbaikiDataPanenPage;